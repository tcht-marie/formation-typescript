 ...
 *
 */
const multiplyByTwo = (array) => array.map((arr) => arr * 2);
...
const filterNameStartByA = (array) =>
  array.filter((word) => word.startsWith("A"));
//words = ["Ananas", "Bambou", "Doudou", "Angular"];
//console.log(filterNameStartByA(words));
...
const sum = (array) => array.reduce((acc, cValue) => acc + cValue, 0);
